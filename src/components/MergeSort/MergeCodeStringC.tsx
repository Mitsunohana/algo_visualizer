export const MergeCodeStringC = () => {
  return (
    <>
      ...
      <span className="code-punc">&lt;stdio.h&gt;</span>
      <br />
      <span className="code-keyword">#include </span>
      <span className="code-punc">&lt;stdlib.h&gt;</span>
      <br />
      <br />
      ...
      <span className="code-operator">*</span>
      <span className="code-punc">)</span>
      <span className="code-builtin">malloc</span>
      <span className="code-punc">(</span>
      <span className="code-variable">n1</span>
      <span className="code-operator">*</span>
      <span className="code-builtin">sizeof</span>
      <span className="code-punc">(</span>
      ...
      <span className="code-operator">=</span>
      <span className="code-number">0</span>
      <span className="code-punc">; j</span>
      <span className="code-operator">&lt;</span>
      <span className="code-variable">n2</span>
      <span className="code-punc">; </span>
      <span className="code-variable">j</span>
      ...
      <span className="code-variable">i</span>{" "}
      <span className="code-operator">&lt;</span>{" "}
      <span className="code-variable">n1</span>)<br />
      &nbsp;&nbsp;&nbsp;&nbsp;
      <span className="code-variable">arr</span>
      <span className="code-punc">[</span>
      <span className="code-variable">k</span>
      ...
      <br />
      <br />
      &nbsp;&nbsp;<span className="code-builtin">free</span>
      <span className="code-punc">(</span>
      <span className="code-variable">L</span>
      <span className="code-punc">)</span>
      <span className="code-punc">;</span>
      ...
      <span className="code-operator">+</span>{" "}
      <span className="code-punc">(</span>
      <span className="code-variable">right - left</span>
      <span className="code-punc">)</span>{" "}
      <span className="code-operator">/</span>{" "}
      ...
      <span className="code-variable">arr</span>
      <span className="code-punc">,</span>{" "}
      <span className="code-variable">mid + 1</span>
      <span className="code-punc">,</span>{" "}
      <span className="code-variable">right</span>
      <span className="code-punc">)</span>
      <span className="code-punc">;</span>
